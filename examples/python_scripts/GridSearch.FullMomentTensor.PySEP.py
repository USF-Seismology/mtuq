...
if __name__=='__main__':
    ...
    path_data=    fullpath('data/observed/20210619214305000/*.[zrt]')
    path_weights= fullpath('data/observed/20210619214305000/weight.dat')
    event_id=     '20210619214305000'
    model=        'ak135'


    #
    # run -n <NPROC>   # Body and surface wave measurements will be made separately
    #
    ...
    #
    origin = Origin({
        'time': '2021-06-19T21:43:05.000000Z',
        'latitude': 63.999,
        'longitude': -149.780,
        'depth_in_m': 12700.,
        'id': '20210619214305000'
        })
    '''
    origin = Origin({
