...
if __name__=='__main__':
    ...
    path_data=    fullpath('data/observed/20171201023246000/*.[zrt]')
    path_weights= fullpath('data/observed/20171201023246000/weight.dat')
    event_id=     '20171201023246000_surface_20-100'
    model=        'ak135'
    ...
    process_sw = ProcessData(
        filter_type='Bandpass',
        freq_min=1.0/100, #0.025, # 40s
        freq_max=1.0/20, #0.0625, # 16s
        pick_type='taup',
        taup_model=model,
    ...
    origin = Origin({
        'time': '2017-12-01T02:32:46.000000Z',
        'latitude': 30.746,
        'longitude': 57.307,
        'depth_in_m': 9000.,
        'id': '20171201023246000'
        })
